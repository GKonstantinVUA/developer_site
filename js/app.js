(() => {
 ...
 //!Викликаємо перевірку вікна при зміні розміру вікна
    ...
    function findVideos() {
        let videos = document.querySelectorAll(".testimonial__inner-video");
        for (let i = 0; i < videos.length; i++) setupVideo(videos[i]);
    }
    function setupVideo(video) {
        let link = video.querySelector(".testimonial__video-link");
        let media = video.querySelector(".testimonial__video-slide");
        let button = video.querySelector(".testimonial__play-video");
        ...
        video.classList.add("testimonial__inner-video--enabled");
    }
    function parseMediaURL(media) {
        let regexp = /https:\/\/i\.ytimg\.com\/vi\/([a-zA-Z0-9_-]+)\/maxresdefault\.(jpg|webp)/i;
        let url = media.src;
    ...
    function createIframe(id) {
        ...
        iframe.classList.add("testimonial__video-slide");
        return iframe;
    }
